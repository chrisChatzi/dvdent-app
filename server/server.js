...
// mongoDB init
    var mongoDBFunction = (function(){
        ...
        // Users.find({}, function(err, user) {
            // if (err) throw err;
            // console.log(user)
            // gmail: dv-service-HM74
            // mongo: dv-service-HM74-m
            // bcrypt.hash('dvdent-21!V', bcrypt.genSaltSync(10), null, function(errCrypt, hash) {
            //     if(errCrypt) console.error(errCrypt);
            //     Users.findOneAndUpdate({ name: 'boss' }, { password: hash }, function(err, user) {
            //       if (err) throw err;
            //     });
            // });
            // console.log(typeof user.password);
            // bcrypt.compareSync(password, this.password)
        //     bcrypt.compare('dvdent-21!V', user[0].password, function(err, res) {
        //         if(err) throw err
        //         console.log(res)
        //     });
        // });
        ...
        //express
            ...
            //ajax
                ...
                app.post('/findLast', function (req, res) {
                    ...
                    // var days = 30;
                    // ProductsList.find({ created: {$gt: +new Date()-(days*100000000)} }, function(err, products) {
                    //     if (err) throw err;
                    //     console.log('got em!', products.length);
                    //     // res.send(JSON.stringify({success: true}))
                    // });
                });
